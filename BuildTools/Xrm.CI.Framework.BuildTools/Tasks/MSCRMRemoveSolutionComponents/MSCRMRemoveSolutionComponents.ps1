...
& "$mscrmToolsPath\xRMCIFramework\9.0.0\RemoveSolutionComponents.ps1" -solutionName "$solutionName" -crmConnectionString "$CrmConnectionString" -Timeout $crmConnectionTimeout
